    ...
    />
      ...
      >
        <Image
          ...
          className="w-20 h-20 md:w-14 md:h-14" // Tamanhos responsivos
        />
      </a>

      {/* Começo do conteúdo da página*/}
      <div className='grid grid-flow-row gap-32 px-28 py-32 mt-32'>

        <div className='grid grid-flow-row gap-12 place-items-center'>
          ...
          <div className='grid grid-flow-col gap-14 items-center place-items-center'>
            <Image
            src="/cs2.png"
            width={116}
            height={116}
        ...
        <div className='grid grid-flow-row gap-9 place-items-center'>
          ...
          <div className='items-center grid grid-flow-col gap-36'>
            <Image
            src='/the-move.png' 
            width={260}
            height={28}
        ...
        <div className='grid grid-flow-row gap-9 items-center place-items-center'>
        ...
        <div className='grid grid-flow-row gap-14 items-center place-items-center'>
        ...
        <div className='grid grid-flow-row gap-14 items-center place-items-center'>
          ...
          <div className='grid grid-flow-col gap-20 items-center place-items-center'>
            <Image
            src='/adidas-logo.png'
            width={177}
            height={177}
